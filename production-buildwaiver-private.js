...
let oldData;
let newData;
const DATAURL = "https://submission.forms.gov/mia-live/madeinamericanonavailabilitywaiverrequest/submission"
const GITHUBURL = "https://api.github.com/repos/GSA/made-in-america-data-private/contents/waivers-data.json"
...
async function getData(url) {
  try {
    ...
    const result = await axios(url, {
      method: 'get',
      headers: {
        'x-token': 'RZoI7g0jw6D0ScQRxME9UVhCyKMaGF'
      }
    })
